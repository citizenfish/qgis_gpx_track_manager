...
SOURCES = \
	__init__.py \
	gpxTrackManager.py gpxTrackManager_dockwidget.py

PLUGINNAME = gpxTrackManager

PY_FILES = \
	__init__.py \
	gpxTrackManager.py gpxTrackManager_dockwidget.py

UI_FILES = gpxTrackManager_dockwidget_base.ui
...
QGISDIR=/Users/daveb/Library/Application Support/QGIS/QGIS3/profiles/default/python/plugins
